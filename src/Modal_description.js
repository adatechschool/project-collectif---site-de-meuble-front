...
class ModalDescription extends React.Component{
    ...
    render () {
      ...
      return (
        ...
        <div className="modal_description_content" onClick={e => e.stopPropagation()}>
            <div className="modal_description_header">
                <button onClick={this.props.onClose} className="button-description">X</button>
            </div>
                ...
                <div className="sub-wrapper-top">
                   ...
                   <div className="info_description">
                       <h3>
                        ...
                        <button className="button_description_basket">Ajouter au panier</button>
                   </div>
                </div>
            ...
            <div className="modal_description_footer">   
            </div>
        </div>
    </div>
      )
